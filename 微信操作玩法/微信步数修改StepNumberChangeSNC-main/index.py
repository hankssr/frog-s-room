...
def main(user, passwd, step):
    ...
    if step == '':
        print ("已设置为随机步数（30000-39999）")
        step = str(random.randint(30000,39999))
    login_token = 0
    ...
    print(result)
    qqtalk = 'https://qmsg.zendee.cn/send/da2165412312321325e5c998a5912?msg='  + user + "  " + "已修改随机步数："  + " " + step + "  " + response[
        'message'] + '&qq=739634401'
    requests.get(qqtalk)
    return result
